...
export class NoOwnerInformationListComponent implements OnInit {
  ...
  tab: any = 'noowner-information-group';
  ...
  LoadData(pages: any) {
    ...
    if (this.authenticationToken != null) {
      ...
      const configModal = this.themeConfig.defaultSettings.dialogAlertSetting;
      const authorization = 'Bearer ' + this.authenticationToken;
      const endpoint = Survey.NoOwner.Inquiry.ListByRound;
  ...
  ManageNoOwnerInformation(roundCode: any) {
    this.router.navigate(['survey/animal-no-owner/noowner-information', {roundcode : roundCode}]);
  }

  ActionEditContent(contentObj: any) {
    // tslint:disable-next-line:max-line-length
    this.router.navigate(['survey/animal-no-owner/noowner-information', {roundcode: contentObj.roundCode, ownercode: contentObj.surveyCode}]);
  }
}
