...
@Component({
  selector: 'app-dialog-content-video-manage',
  templateUrl: './dialog.content.video.manage.component.html',
  styleUrls: ['./dialog.content.video.manage.component.scss'],
  encapsulation: ViewEncapsulation.None,
  providers: [CallApiService]
})
export class DialogContentVideoManageComponent implements OnInit {
  ...
  ContentSelect(contentObj: any, disabled: boolean) {
    if (this.authenticationToken != null) {
      ...
      const authorization = 'Bearer ' + this.authenticationToken;
      const endpoint = Content.Video.Inquiry.ById;
