...
import { DialogContentNewsManageComponent } from './dialog-content-news-management/dialog.content.news.manage.component';

@Component({
  selector: 'app-content-news-manage',
  templateUrl: './content.news.manage.component.html',
  styleUrls: ['./content.news.manage.component.scss'],
  encapsulation: ViewEncapsulation.None,
  providers: [CallApiService]
})
export class ContentNewsManageComponent implements OnInit {
  modalRef: BsModalRef;
  ...
  LoadData(pages: any, animalTypeCode: any) {
    if (this.authenticationToken != null) {
      ...
      const endpoint = Content.News.Inquiry.ByList.List;
  ...
  ActionDeleteContent(dataContent: any) {
    if (this.authenticationToken != null) {
      ...
      bsModalRefObj.content.action.subscribe(result => {
        ...
        if (result.status) {
          const authorization = 'Bearer ' + this.authenticationToken;
          const endpoint = Content.News.Delete;
