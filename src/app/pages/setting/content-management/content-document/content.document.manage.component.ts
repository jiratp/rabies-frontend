...
import { DialogContentDocumentManageComponent } from './dialog-content-document-management/dialog.content.document.manage.component';

@Component({
  selector: 'app-content-document-manage',
  templateUrl: './content.document.manage.component.html',
  styleUrls: ['./content.document.manage.component.scss'],
  encapsulation: ViewEncapsulation.None,
  providers: [CallApiService]
})
export class ContentDocumentManageComponent implements OnInit {
  modalRef: BsModalRef;
