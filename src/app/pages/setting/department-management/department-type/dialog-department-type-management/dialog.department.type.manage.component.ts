...
@Component({
  selector: 'app-dialog-department-type-manage',
  templateUrl: './dialog.department.type.manage.component.html',
  styleUrls: ['./dialog.department.type.manage.component.scss'],
  encapsulation: ViewEncapsulation.None,
  providers: [CallApiService]
})
export class DialogDepartmentTypeManageComponent implements OnInit {
    ...
    if (this.authenticationToken != null) {
      ...
      if (this.ContentForm.valid) {
        ...
        if (this.actionForm === 'add') {
          endpoint = Department.Type.Create;
          newEndpoint = endpoint.url;
        } else if (this.actionForm === 'edit') {
          endpoint = Department.Type.Update;
          newEndpoint = endpoint.url;
        }
