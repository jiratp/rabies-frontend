...
import { DialogDepartmentTypeManageComponent } from './dialog-department-type-management/dialog.department.type.manage.component';

@Component({
  selector: 'app-department-type-manage',
  templateUrl: './department.type.manage.component.html',
  styleUrls: ['./department.type.manage.component.scss'],
  encapsulation: ViewEncapsulation.None,
  providers: [CallApiService]
})
export class DepartmentTypeManageComponent implements OnInit {
  modalRef: BsModalRef;
  ...
  LoadData(pages: any, animalTypeCode: any) {
    if (this.authenticationToken != null) {
      ...
      const endpoint = Department.Type.Inquiry.ByList.List;
  ...
  ActionDeleteContent(dataContent: any) {
    if (this.authenticationToken != null) {
      ...
      bsModalRefObj.content.action.subscribe(result => {
        ...
        if (result.status) {
          const authorization = 'Bearer ' + this.authenticationToken;
          const endpoint = Department.Type.Delete;
