...
import { DialogAnimalSymptomManageComponent } from './dialog-animal-symptom-management/dialog.animal.symptom.manage.component';

@Component({
  selector: 'app-animal-symptom-manage',
  templateUrl: './animal.symptom.manage.component.html',
  styleUrls: ['./animal.symptom.manage.component.scss'],
  encapsulation: ViewEncapsulation.None,
  providers: [CallApiService]
})
export class AnimalSymptomManageComponent implements OnInit {
  modalRef: BsModalRef;
  ...
  LoadData(pages: any) {
    if (this.authenticationToken != null) {
      ...
      const endpoint = Animal.Symptom.Inquiry.ByList.List;
  ...
  ActionDeleteContent(dataContent: any) {
    if (this.authenticationToken != null) {
      ...
      bsModalRefObj.content.action.subscribe(result => {
        ...
        if (result.status) {
          const authorization = 'Bearer ' + this.authenticationToken;
          const endpoint = Animal.Symptom.Delete;
