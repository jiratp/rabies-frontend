...
@Component({
  selector: 'app-dialog-animal-type-manage',
  templateUrl: './dialog.animal.type.manage.component.html',
  styleUrls: ['./dialog.animal.type.manage.component.scss'],
  encapsulation: ViewEncapsulation.None,
  providers: [CallApiService]
})
export class DialogAnimalTypeManageComponent implements OnInit {
  ...
  ContentSelect(contentObj: any, disabled: boolean) {
    if (this.authenticationToken != null) {
      ...
      const endpoint = Animal.Type.Inquiry.ById;
    ...
    if (this.authenticationToken != null) {
      ...
      if (this.ContentForm.valid) {
        ...
        if (this.actionForm === 'add') {
          endpoint = Animal.Type.Create;
        } else if (this.actionForm === 'edit') {
          endpoint = Animal.Type.Update;
        }
