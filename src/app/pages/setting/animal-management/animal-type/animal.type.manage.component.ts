...
import { DialogAnimalTypeManageComponent } from './dialog-animal-type-management/dialog.animal.type.manage.component';

@Component({
  selector: 'app-animal-type-manage',
  templateUrl: './animal.type.manage.component.html',
  styleUrls: ['./animal.type.manage.component.scss'],
  encapsulation: ViewEncapsulation.None,
  providers: [CallApiService]
})
export class AnimalTypeManageComponent implements OnInit {
  modalRef: BsModalRef;
  ...
  LoadData(pages: any) {
    if (this.authenticationToken != null) {
      ...
      const endpoint = Animal.Type.Inquiry.ByList.List;
  ...
  ActionDeleteContent(dataContent: any) {
    if (this.authenticationToken != null) {
      ...
      bsModalRefObj.content.action.subscribe(result => {
        ...
        if (result.status) {
          const authorization = 'Bearer ' + this.authenticationToken;
          const endpoint = Animal.Type.Delete;
